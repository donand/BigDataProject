...
event['phone_count'] = pd.Series([cell['activity'] for index, row in event.iterrows() for index, cell in phone.iterrows() if belong_to_cell(row['latitude'], row['longitude'], cell['lat'], cell['lon'])])
